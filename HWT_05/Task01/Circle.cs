namespace Task01
{
    ...
    public class Circle
    {
        ...
        /// на privat, мне запрещается использовать ее в другом классе, а на то что я поставил pn так она локальная же, для чего она тебе в другом классе?
        /// модификатор protected он не реагирует.
        /// 
        /// еще StyleCop и ReSharper конфилктуют между собой снизу, где я пишу перед переменной
        /// "this." один говорит что так надо, другой что это useless. pn на эту проверку можно забить
        /// </summary>
